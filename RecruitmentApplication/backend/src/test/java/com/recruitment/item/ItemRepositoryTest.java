...
import com.recruitment.TestCreationFactory;
import com.recruitment.item.model.Item;
import com.recruitment.review.Rating;
import com.recruitment.review.ReviewRepository;
...
import static com.recruitment.item.ItemSpecifications.*;
import static com.recruitment.review.Rating.AVERAGE;
import static com.recruitment.review.Rating.EXCELLENT;
import static com.recruitment.user.model.ERole.*;
...
//    assertEquals(1951, pagedResult.getTotalElements());
    ...
    void testWildlyComplicatedQuery() {
        ...
        final User seeker = userRepository.save(User.builder()
                .username("seeker")
                .email("seeker@users.com")
                .password("stronk")
                .roles(Set.of(roleRepository.findByName(SEEKER).get()))
                .build());
        ...
        addRandomReview(laptop, recruiter);
        addRandomReview(mac, seeker);
